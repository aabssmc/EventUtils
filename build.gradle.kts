...
var modVersion = "1.4"
setupJava("cc.aabss", "1.20.2-${project.version}", "Alerting for Event Alerts Minecraft events")
...
dependencies {
    ...
    modImplementation("dev.isxander", "yet-another-config-lib", "3.5.0+1.20.1-fabric")
